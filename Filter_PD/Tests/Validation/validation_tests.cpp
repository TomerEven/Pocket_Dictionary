...
//        validate_get_interval_functions(pd, a_size, q);
        }
        return true;
    }
...
////}
    ...
    template<>
    auto validate_PD<cc_pd<>>(size_t reps, bool to_seed, bool to_print) -> bool {
        size_t f = 51;
        size_t m = 50;
        size_t l = 8;
        ...
        using T = cc_pd<>;
        auto d = T(m,f,l);
        auto res = validate_PD_core(reps, &d, m, f, l, to_print, 0);
